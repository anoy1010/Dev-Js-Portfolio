...
import { signup, signupWithGoogle, signupWithFacebook, signupWithApple } from '../firebase';
...
export default function Signup({ route, navigation }) {
  ...
  const handleSignUp = (navigation, email, password) => {
    let errorMessage = '';
    signup(email, password)
      .then(() => navigation.navigate('MyInfos', { isPro: isPro, fromSignup: true }))
      .catch((error) => {
    ...
    <ScrollView>
      <View style={styles.container}>
        ...
        <GradientButton
          ...
          impact
          impactStyle='Light'
          onPressAction={() => handleSignUp(navigation, email, password)}
        />
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('SignupWithPhone', { isPro: isPro })}
          underlayColor='#fff'
        >
          <Entypo style={styles.icon} name="phone" size={24} color="black" />
          <Text style={[styles.submitText, styles.googleText]}>S'inscrire via téléphone</Text>
        </TouchableOpacity>
        ...
        >
          ...
          <Text style={[styles.submitText, styles.facebookText]}>S'inscrire avec Facebook</Text>
        </TouchableOpacity>
        ...
        >
          ...
          <Text style={[styles.submitText, styles.googleText]}>S'inscrire avec Google</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          underlayColor='#fff'
        >
          <Text style={styles.cgvText}>En m'inscrivant, j'accepte</Text>
          <Text style={[styles.cgvText, styles.bold, styles.darkColor]}>les conditions générales de ventes et d'utilisation</Text>
        </TouchableOpacity>
